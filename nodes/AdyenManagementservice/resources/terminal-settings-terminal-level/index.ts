...
export const terminalSettingsTerminalLevelDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/terminals/{{$parameter[\"terminalId\"]}}/terminalLogos"
						}
					}
				},
				{
				...
				},
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/terminals/{{$parameter[\"terminalId\"]}}/terminalSettings"
						}
					}
				},
				{
		...
		{
			"displayName": "GET /terminals/{terminalId}/terminalLogos",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PATCH /terminals/{terminalId}/terminalLogos",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /terminals/{terminalId}/terminalSettings",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PATCH /terminals/{terminalId}/terminalSettings",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
